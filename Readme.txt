====================================
HOW TO USE LOKI AND ITS CONFIG-FILES:
====================================
...
2. enter "python [path to Thor2.py relative to your current location] [path to configuration file relative to Thor2.py]"
	example: "python Thor2.py config.ini"
	
It's recommended to store Thor2.py and the configuration file or a folder with multible configuration files in the same folder
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Working with the config file for 
generating attributed variability models 
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
[UseCase]
UseCase:
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Working with the config file for 
modifying attributed variability models
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
Trouble Shooting 
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
There is the possibility of encountering the following error message, when running Thor2:
	dask.async.IndexError: pop from empty list
To solve this problem, please replace the sklearn file "base.py", which can be found under "Anaconda3\Lib\site-packages\sklearn" with the corrected "base.py" provided in the Thor2-folder
